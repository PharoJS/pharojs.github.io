// generated by PharoJS *** DO NOT EDIT *** on 2021-02-21T21:39:29.011536+01:00 by noury
'use strict';
...
i$(function pj_identityHash(){return 876691968});
...
PjFileBasedWebApp.pj_subclass_("PjDisjointForceDirectedGraphExample");
PjDisjointForceDirectedGraphExample.$$def(function(i$,c$,cp$){
i$(function pj_addMouseActions(){var $_self_$=this;$asNil$(this.svgNodes).pj_on_do_("click",function(event){return $_self_$.pj_onClick_(event)});$asNil$(this.svgNodes).pj_call_(this.pj_onDrag());return this});
i$(function pj_createSimulationWith_(data){var forceId,distance,strength;this.dataNodes=$asNil$($asNil$(data).pj_result()).pj_nodes();this.dataLinks=$asNil$($asNil$(data).pj_result()).pj_links();this.simulation=$asNil$(d3).pj_forceSimulation_(this.dataNodes);forceId=$asNil$($asNil$(d3).pj_forceLink_(this.dataLinks)).pj_id_(function(d){return $asNil$(d).pj_id()});distance=$asNil$(forceId).pj_distance_(function(d){return 1.0.pj_47_($asNil$(d).pj_score())});strength=$asNil$(distance).pj_strength_(function(d){return $asNil$(d).pj_score()});$asNil$(this.simulation).pj_force_with_("link",strength);$asNil$(this.simulation).pj_force_with_("charge",$asNil$(d3).pj_forceManyBody());$asNil$(this.simulation).pj_force_with_("center",$asNil$(d3).pj_forceCenter());return this});
i$(function pj_createSvg(){var obj,$_self_$=this;this.svg=$asNil$(d3).pj_create_("svg");$asNil$(this.svg).pj_attr_with_("preserveAspectRatio","xMidYMid meet");obj=$asNil$(this.svg).pj_append_("g");obj=$asNil$(obj).pj_attr_with_("stroke","#999");obj=$asNil$(obj).pj_attr_with_("stroke-opacity",0.8);obj=$asNil$(obj).pj_selectAll_("line");obj=$asNil$(obj).pj_data_(this.dataLinks);obj=$asNil$(obj).pj_join_("line");this.svgLinks=$asNil$(obj).pj_attr_with_("stroke-width",function(d){return $asNil$(d).pj_score()*7.0});obj=$asNil$(this.svg).pj_append_("g");obj=$asNil$(obj).pj_attr_with_("stroke","#fff");obj=$asNil$(obj).pj_attr_with_("stroke-opacity",0.5);obj=$asNil$(obj).pj_selectAll_("circle");obj=$asNil$(obj).pj_data_(this.dataNodes);obj=$asNil$(obj).pj_join_("circle");obj=$asNil$(obj).pj_attr_with_("r",5);this.svgNodes=$asNil$(obj).pj_attr_with_("fill",function(){return $_self_$.pj_randomColor()});return this});
i$(function pj_d3(){return d3});
i$(function pj_initialize(){var $_self_$=this;PjFileBasedWebApp.prototype.pj_initialize.call(this);$asNil$($asNil$(d3).pj_json_("graph.json")).pj_then_(function(data){var node;$_self_$.pj_createSimulationWith_(data);$_self_$.pj_createSvg();$_self_$.pj_addMouseActions();node=$asNil$($_self_$.svg).pj_node();$asNil$($asNil$(document).pj_body()).pj_append_(node);return $asNil$($_self_$.simulation).pj_on_do_("tick",function(){return $_self_$.pj_updateDisplay()})});return this});
i$(function pj_maxOf_(aCollection){return Math.max(...aCollection)});
i$(function pj_minOf_(aCollection){return Math.min(...aCollection)});
i$(function pj_onClick_(event){var clickedNode,index;clickedNode=$asNil$(event).pj_target();index=$asNil$($asNil$($asNil$(clickedNode).pj_parentNode()).pj_children()).pj_indexOf_(clickedNode);$asNil$(window).pj_alert_($asNil$($asNil$(this.dataNodes).pj_at_(index)).pj_title());return this});
i$(function pj_onDrag(){var dragStarted,dragged,dragEnded,obj,$_self_$=this;dragStarted=function(event){if(false==$asNil$(event).pj_active()){$asNil$($asNil$($_self_$.simulation).pj_alphaTarget_(0.3)).pj_restart()};$asNil$($asNil$(event).pj_subject()).pj_at_put_("fx",$asNil$($asNil$(event).pj_subject()).pj_x());return $asNil$($asNil$(event).pj_subject()).pj_at_put_("fy",$asNil$($asNil$(event).pj_subject()).pj_y())};dragged=function(event){$asNil$($asNil$(event).pj_subject()).pj_at_put_("fx",$asNil$(event).pj_x());return $asNil$($asNil$(event).pj_subject()).pj_at_put_("fy",$asNil$(event).pj_y())};dragEnded=function(event){if(false==$asNil$(event).pj_active()){$asNil$($_self_$.simulation).pj_alphaTarget_(0)};$asNil$($asNil$(event).pj_subject()).pj_fx_(undefined);return $asNil$($asNil$(event).pj_subject()).pj_fy_(undefined)};obj=$asNil$(d3).pj_drag();obj=$asNil$(obj).pj_on_with_("start",dragStarted);obj=$asNil$(obj).pj_on_with_("drag",dragged);return $asNil$(obj).pj_on_with_("end",dragEnded)});
i$(function pj_randomColor(){var colors,randomIndex;colors=["pink","red","blue","green","yellow","orange","purple"];randomIndex=this.pj_randomIndexOf_(colors);return $asNil$(colors).pj_at_(randomIndex)});
i$(function pj_randomIndexOf_(aCollection){let min = 1;
  let max = aCollection.length;
  return Math.floor(Math.random() * (max - min) + min);});
i$(function pj_updateDisplay(){var nodes_x,nodes_y,min_x,min_y,w,h,$2,$1;$1=$asNil$(this.svgLinks);$1.pj_attr_with_("x1",function(d){return $asNil$($asNil$(d).pj_source()).pj_x()});$1.pj_attr_with_("y1",function(d){return $asNil$($asNil$(d).pj_source()).pj_y()});$1.pj_attr_with_("x2",function(d){return $asNil$($asNil$(d).pj_target()).pj_x()});$1.pj_attr_with_("y2",function(d){return $asNil$($asNil$(d).pj_target()).pj_y()});$2=$asNil$(this.svgNodes);$2.pj_attr_with_("cx",function(d){return $asNil$(d).pj_x()});$2.pj_attr_with_("cy",function(d){return $asNil$(d).pj_y()});nodes_x=$asNil$(this.dataNodes).pj_map_(function(d){return $asNil$(d).pj_x()});nodes_y=$asNil$(this.dataNodes).pj_map_(function(d){return $asNil$(d).pj_y()});min_x=this.pj_minOf_(nodes_x)-10;min_y=this.pj_minOf_(nodes_y)-10;w=$asNil$(this.pj_maxOf_(nodes_x)).pj_45_(min_x)+10;h=$asNil$(this.pj_maxOf_(nodes_y)).pj_45_(min_y)+10;$asNil$(this.svg).pj_attr_bounds_("viewBox",[min_x,min_y,w,h]);return this});
})
Smalltalk.pj_registerDnuForAll_(["%","*","+",",","-","->","/","//","<<","=","@","\\\\","abs","active","adaptToPoint:andSend:","add:","addAll:","addAllLast:","addDateAndTime:","addElement:to:","addElement:to:style:","addEventListener:block:","addFirst:","addKnownObject:","addLast:","addMouseActions","adhereTo:","adoptInstance:","alert:","allButFirst:","allButLast:","allEnumeratableKeysDo:","allPhxJsonInstvarNames","allSubclassesDo:","alphaTarget:","angle","append:","appendChild:","appendTo:","apply:with:","arcTan","arcTan:","arguments","as:","asArray","asCharacter","asDictionary","asDuration","asFloat","asHours","asInteger","asJSON","asJsObject","asMinutes","asNanoSeconds","asPoint","asString","asUppercase","asciiValue","associationsDo:","at:","at:ifAbsent:","at:ifAbsentPut:","at:ifPresent:","at:ifPresent:ifAbsent:","at:put:","atEnd","atGlobalVarName:put:","attr:bounds:","attr:with:","attribute:at:set:","attribute:ofElement:","attribute:ofElement:set:","back","basicAt:","basicNew","basicNew:","basicNew:with:","basicNew:with:with:","basicNew:with:with:with:","basicNew:with:with:with:with:","basicSubtractFromDateAndTime:","beginsWith:","between:and:","bitAnd:","bitShift:","bitXor:","body","bottom","call:","call:with:","call:with:with:","call:with:with:with:","canUnderstand:","capitalized","ceiling","children","class","className","classPool","classSubclassResponsibilitySet","closeTo:","collect:","comma","containsPoint:","contents","contents:","copyFrom:to:","cos","cr","create:","createElement:","createElement:style:","createSimulationWith:","createSvg","crossProduct:","cssClassesElement:","cssClassesElement:set:","cssClassesReplaceAll:byAll:element:","cssClassesStringElement:","cssClassesStringElement:set:","cull:","cull:cull:","currentInstance","currentWorld","data:","day","dayOfMonth","days","days:","days:hours:minutes:seconds:nanoSeconds:","days:seconds:","daysSecondsCount","deepCopy","defaultSort:to:","degreesToRadians","denormalized","detect:ifFound:ifNone:","display:","displayScaleFactor","distance:","distanceTo:","dividend:","do:","do:separatedBy:","doBetweenCurlyBraces:","doBetweenSquareBrackets:","doWithIndex:","document","dotProduct:","drag","elementAt:","elementAt:in:","emptyCollection","emptyJavascriptObject","ensure:","ensureObjectRegistered:","ensureOidOnObject:","eqv:","error:","errorNotFound:","even","eventProxyInfo","eventProxyInfo:","eventTargetProxyInfo:","exp","findDelimiters:startingAt:","findIndex:","first","flatCollect:as:","floor","floor:","fminDenormalized","fminNormalized","force:with:","forceCenter","forceLink:","forceManyBody","forceSimulation:","fractionPart","from:","fromPoint:","fx:","fy:","getAttribute:","getDate","getDay","getElementById:","getFullYear","getHours","getMilliseconds","getMinutes","getMonth","getOidFrom:","getSeconds","globalName","globalName:","handleDNU:for:","hash","hashMultiply","height","hide:","highBit","highBitOfPositiveReceiver","hour24","hours","hours:","hoursCount","hoursSecondsCount","id","id:","identityHash","identityIndexOf:","ifEmpty:","ifTrue:ifFalse:","includes:","includesKey:","indexForInserting:","indexOf:","indexOf:startingAt:","inheritsFrom:","initNilInJs","initObject","initThrowInJs","initialize","innerHTML","innerHTML:","inputWidgetForPoint","insert:before:","instVarNamed:","instVarNamed:put:","instVarNamed:putHidden:","installDnuArgs:selector:js:for:else:","integerPart","isBlock","isCharacter","isEmpty","isFloat","isFloatPoint","isFraction","isFunction:","isInteger","isIntegerPoint","isKindOf:","isLetter","isNil","isNotEmpty","isNotNil","isNumber","isPharoJsSelector:","isPoint","isVowel","isZero","join","join:","js_apply:args:","js_charAt:","js_charCodeAt:","js_defineProperty:field:properties:","js_forEach:","js_fromCharCode:","js_hasOwnProperty:","js_join:","js_log:","js_parse:","js_pop","js_push:","js_shift","js_split:","js_substring:","js_substring:to:","js_toLowerCase","js_toString","js_toUpperCase","json:","key","key:","key:value:","keyFrom:","keys","keysAndValuesDo:","keysDo:","left","leftRotated","letterCharCodes","lf","lineIndicesDo:","links","ln","load:","log:","logDescription","makeDNU:","makeGetter:","makePharoJsSelector:","makeSetter:","makeSubclass","map:","materialize","materializeFromArray:","materializeFromString:","max:","maxOf:","messageClass:","messageText:","metaclassClass:","metaclassOf:","methods","milliSeconds","milliSeconds:","millisecondsCount","min:","minOf:","minute","minutes","minutes:","minutesCount","month:","monthIndex","monthSecondsCount","months","months:","name","nanoSeconds:","nearestPointAlongLineFrom:to:","negated","negative","new","new:","newFrom:","newFromMaterialized:","newPhxJsonWriter","newWithId","next","nextGlobalVarName","nextIdNumber","nextIdentityHash","nextMessageId","nextOid","nextPut:","nextPutAll:","nilIfUndefined","nilInJs:","nilTestFunctionName","node","nodes","not","notNil","now","ofSize:","oid","oid:","oidInstVarName","on:","on:do:","on:with:","onChange:in:do:","onChangeElement:do:","onClick:","onClick:in:do:","onClickElement:do:","onDrag","onKeyUp:in:do:","onKeyUpElement:do:","onLineFrom:to:within:","one","origin:corner:","origin:extent:","parentNode","parse:","parseListDo:","peek","perform:","perform:with:","pharoJsSelectorPrefix","phxJsonClassName","pi","point:point:","position","position:","positionError","positive","postCopy","precision","printDetailsOn:","printOn:","printString","propertySet:","prototype","proxyResponse","quadrantOf:","querySelector:","quo:","r","radiansToDegrees","raisedTo:","raisedToFraction:","raisedToInteger:","randomColor","randomIndexOf:","reSort","readFromJsObjectOrDictionary:","readStream","receiverProxyInfo","receiverProxyInfo:","reciprocal","rectangle:","registerDnu:","rem:","remove","remove:","remove:ifAbsent:","removeAll","removeAt:","removeFirst","removeKey:","replaceFrom:to:with:","replaceFrom:to:with:startingAt:","reset","respondsTo:","restart","result","reverse","right","rightRotated","roundDownTo:","roundTo:","roundUpTo:","rounded","score","second","seconds","seconds:","seconds:nanoSeconds:","secondsCount","secondsInDay","secondsInMonth","secondsInWeek","secondsInYear","select:","selectAll:","selector","selectors","sendsSelector:","serializationArray","serializationContents","setAttribute:to:","setElement:style:","setHours:","setMilliseconds:","setMinutes:","setOid:on:","setPoint:point:","setR:degrees:","setSeconds:","setX:setY:","shallowCopy","shouldNotImplement","show:","show:element:","show:elementAt:in:","sideOf:","sign","signal","signal:","sin","size","skip:","skipDelimiters:startingAt:","sort","sort:","sortBlock","sortBlock:","sortUsing:","source","sourceElement","space","species","splice:remove:element:","split:","sqrt","start","startInstance","stop","stopPropagation","streamContents:","strength:","string","stringHash:initialHash:","stringify:","style","subclassResponsibility","subclassResponsibilitySet","subclassSelector","subclasses","subclassesDo:","subject","subscribeToDeviceEvents","subtractFromDateAndTime:","superclass","swap:with:","target","then:","theta","throwFunction","throwFunctionName","timesTwoPower:","title","to:","to:by:do:","to:do:","to:sideOf:","toISOString","todayHour:minute:second:","tomorrowHour:minute:second:","top","topLeft","totalSeconds","triangleArea:with:","truncateTo:","truncated","tryToSendMessage:","typeof","updateDisplay","value","value:","value:value:","value:value:value:","value:value:value:value:","valuesDo:","visitPoint:","weeks","weeks:","weeksSecondsCount","whenJsReady:","whileFalse:","whileTrue","whileTrue:","wholeMilliseconds","width","with:","with:do:","with:with:with:","with:with:with:with:","withAll:","withIndexDo:","writeKeyName:andValue:","writeObject:streamShortList:","writePhxJsonObjectOn:","writePhxJsonOn:","writePhxJsonRepresentationOn:","writeQuoted:","writeReferenceFor:or:","writeStream","x","x:y:","y","year","year:month:day:hour:minute:second:","years","years:","yourself"]);
(function(appClass){return function(){return $asNil$(appClass).pj_start()}})(PjDisjointForceDirectedGraphExample)();
