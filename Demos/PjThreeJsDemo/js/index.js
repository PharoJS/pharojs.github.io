// generated by PharoJS *** DO NOT EDIT *** on 2022-09-08T12:09:25.489884+02:00 by noury
'use strict';
...
PjSharedPool.pj_subclass_("PjThreeJsGlobals");
PjThreeJsGlobals.$$def(function(i$,c$,cp$){
c$(function pj_javascriptInitialize(){cp$.THREE=$asNil$(window).pj_THREE();cp$.WebGLRenderer=$asNil$(cp$.THREE).pj_WebGLRenderer();cp$.Scene=$asNil$(cp$.THREE).pj_Scene();cp$.BoxGeometry=$asNil$(cp$.THREE).pj_BoxGeometry();cp$.MeshBasicMaterial=$asNil$(cp$.THREE).pj_MeshBasicMaterial();cp$.Mesh=$asNil$(cp$.THREE).pj_Mesh();cp$.PerspectiveCamera=$asNil$(cp$.THREE).pj_PerspectiveCamera();cp$.TextureLoader=$asNil$(cp$.THREE).pj_TextureLoader();return this});
cp$.BoxGeometry=cp$.Mesh=cp$.MeshBasicMaterial=cp$.PerspectiveCamera=cp$.Scene=cp$.THREE=cp$.TextureLoader=cp$.WebGLRenderer=null;
});
